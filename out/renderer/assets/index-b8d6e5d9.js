...
const _excluded$J = ["onClick", "relative", "reloadDocument", "replace", "state", "target", "to", "preventScrollReset", "unstable_viewTransition"];
...
const Link = /* @__PURE__ */ reactExports.forwardRef(function LinkWithRef(_ref7, ref) {
  ...
  } = _ref7, rest = _objectWithoutPropertiesLoose$2(_ref7, _excluded$J);
  let {
    basename
  } = reactExports.useContext(NavigationContext);
  let absoluteHref;
...
const Navbar = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "navbar", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "title", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "cryoDRGN commands" }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "links", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", children: "Home" }) })
  ] });
};
const direct_traversal = {
...
const CommandsList = "";
const CommandList = ({ commands: commands2 }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "command-list", children: Object.entries(commands2).map(([command_name, command_info]) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "command-preview", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/generate", state: { fromCommand: [command_name, command_info.args] }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: command_name }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: command_info.desc })
  ] }, "link" + command_name) }, "summary_" + command_name)) });
};
const Home = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "home", children: commands && /* @__PURE__ */ jsxRuntimeExports.jsx(CommandList, { commands }) });
};
const Generate$1 = "";
const Error$2 = "";
...
function createBreakpoints(breakpoints) {
  const {
    ...
    unit = "px",
    step = 5
  } = breakpoints, other = _objectWithoutPropertiesLoose$1(breakpoints, _excluded$I);
...
function createTheme$1(options = {}, ...args) {
  const {
    ...
    spacing: spacingInput,
    shape: shapeInput = {}
  } = options, other = _objectWithoutPropertiesLoose$1(options, _excluded$H);
...
const _excluded$v = ["action", "children", "className", "closeText", "color", "components", "componentsProps", "icon", "iconMapping", "onClose", "role", "severity", "slotProps", "slots", "variant"];
...
const Alert$1 = Alert;
const Error$1 = ({ errorMessage }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "error", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Alert$1, { severity: "error", children: errorMessage }) });
};
...
const _excluded$u = ["addEndListener", "children", "className", "collapsedSize", "component", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "orientation", "style", "timeout", "TransitionComponent"];
...
const _excluded$t = ["children", "className", "defaultExpanded", "disabled", "disableGutters", "expanded", "onChange", "square", "TransitionComponent", "TransitionProps"];
...
function useSlotProps(parameters) {
  ...
  } = parameters, rest = _objectWithoutPropertiesLoose$1(parameters, _excluded$q);
...
const _excluded$c = ["onEntering"], _excluded2$3 = ["action", "anchorEl", "anchorOrigin", "anchorPosition", "anchorReference", "children", "className", "container", "elevation", "marginThreshold", "open", "PaperProps", "slots", "slotProps", "transformOrigin", "TransitionComponent", "transitionDuration", "TransitionProps", "disableScrollLock"], _excluded3 = ["slotProps"];
...
const Popover = /* @__PURE__ */ reactExports.forwardRef(function Popover2(inProps, ref) {
  ...
  const {
    ...
    disableScrollLock = false
  } = props, TransitionProps = _objectWithoutPropertiesLoose$1(props.TransitionProps, _excluded$c), other = _objectWithoutPropertiesLoose$1(props, _excluded2$3);
...
const _excluded$b = ["onEntering"], _excluded2$2 = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"];
const RTL_ORIGIN = {
  vertical: "top",
  horizontal: "right"
};
...
const Snackbar = /* @__PURE__ */ reactExports.forwardRef(function Snackbar2(inProps, ref) {
  ...
  } = props, TransitionProps = _objectWithoutPropertiesLoose$1(props.TransitionProps, _excluded$3), other = _objectWithoutPropertiesLoose$1(props, _excluded2);
  const ownerState = _extends({}, props, {
    anchorOrigin: {
      vertical,
      horizontal
...
const Generate = () => {
  ...
  const [argValues, setArgValue] = reactExports.useState({});
  ...
  function updateArg(e2, argName, newValue) {
    setArgValue({
      ...argValues,
      [argName]: newValue
    });
  ...
  function generate(e2) {
    e2.preventDefault();
    var result = "cryodrgn " + command_name + " ";
    for (const [_2, args_in_group] of Object.entries(command_args)) {
  ...
  function renderInput(group, arg_name, arg_details) {
    ...
    if ("type" in arg_details) {
      if (arg_details.type == "abspath") {
        return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "path-select", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            "data-toggle": "tooltip",
            "data-placement": "top",
    ...
    if ("const" in arg_details) {
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "toggle", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Switch$1,
          {
            className: "toggle-switch",
            checked: argValues[arg_name] ?? false,
            onChange: (e2) => updateChecked(arg_name, e2.target.checked)
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: argValues[arg_name] ?? false ? arg_details.const.toString() : arg_details.default.toString() })
      ] });
    }
    if ("choices" in arg_details) {
      return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        Select$1,
        {
          ...
          onChange: (e2) => updateArg(e2, arg_name, e2.target.value),
          children: arg_details.choices.map(
            (option) => /* @__PURE__ */ jsxRuntimeExports.jsx(MenuItem$1, { className: "menu-options", value: option, children: option })
          )
        }
      ) });
    }
    if ("nargs" in arg_details && arg_details.nargs > 0) {
      ...
      return nInputs.map((index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          "data-toggle": "tooltip",
          "data-placement": "top",
          ...
          onChange: (e2) => updateArg(e2, arg_name + index, e2.target.value)
        },
        arg_name + index
      ));
    }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "generate", children: [
    generated && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "result-bar", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: generated }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        lib.CopyToClipboard,
        {
          className: "copy",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Snackbar$1,
        {
          ...
          onClose: handleClose,
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(Alert$1, { onClose: handleClose, severity: "success", sx: { width: "100%" }, children: alertMessage })
        }
      )
    ] }),
    command_args ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { style: generated.length > 0 ? { top: "140px" } : { top: "60px" }, children: command_name }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "arguments", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: (e2) => generate(e2), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "accordion", children: Object.entries(command_args).map(([group, args]) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Accordion$1, { defaultExpanded: group == "positional arguments", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionSummary$1, { expandIcon: /* @__PURE__ */ jsxRuntimeExports.jsx(default_1$2, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: group }) }, group + "_name"),
          /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionDetails$1, { children: Object.entries(args).map(([arg_name, arg_details]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: arg_name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip$1, { title: arg_details.help, children: /* @__PURE__ */ jsxRuntimeExports.jsx(IconButton$1, { className: "info-icon", children: /* @__PURE__ */ jsxRuntimeExports.jsx(default_1$1, {}) }) }),
            renderInput(group, arg_name, arg_details)
          ] })) }, group + "_details")
        ] }, group)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", children: "Generate Command" })
      ] }) })
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Error$1, { errorMessage: "Data for this command does not exist" })
  ] });
};
const Slurm$1 = "";
const Slurm = () => {
  const location = useLocation();
  location.state?.generatedCommand;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "slurm", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: output }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: saveAndRun, children: "Click to save and run script" })
  ] });
};
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(HashRouter, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Navbar, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Routes, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { exact: true, path: "/", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Home, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { exact: true, path: "/generate", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Generate, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { exact: true, path: "/slurm", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Slurm, {}) })
    ] })
  ] }) });
}
